...
protected:
    ...
    /** @brief this function is called upon receiving a WhereAmI event  */
    virtual void onWhereAmI(){};
...
protected:
    ...
    /* messages for periodic events such as beacon, whereAmI and WSA transmissions */
    cMessage* sendBeaconEvt;
    cMessage* whereAmIEvt;
    cMessage* sendWSAEvt;
};
